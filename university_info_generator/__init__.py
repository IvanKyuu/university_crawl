...
from university_info_generator.configs.enum_class import BasicInfoType, GPTMethodType, SavedDictType
...
__enum_type__ = ["BasicInfoType", "GPTMethodType", "SavedDictType"]
