...
class GPT4AllClient:
    ...
    def __init__(self):
        ...
        self.gpt_basic_client = GPT4All(model=f"{config.PROJECT_HOME}/university_info_generator/models/mistral-7b-openorca.gguf2.Q4_0.gguf", temp=0, n_threads=20)
        self.gpt_client = GPT4All(model=f"{config.PROJECT_HOME}/university_info_generator/models/mistral-7b-openorca.gguf2.Q4_0.gguf", temp=0, n_threads=20)
    ...
    def get_university_name_from_gpt(self, name: str) -> str:
        ...
        response = self.gpt_basic_client.invoke(
            input=messages
        )
    ...
    def get_value_and_reference_from_gpt(
        ...
        try:
            response = self.gpt_client.chat.completions.invoke(input=messages)
